        ...
        <div class="gp-topbar">
            <div class="container">
                <div class="gp-topbar-inner">
                    ...
                    <a href="tel:<?php echo e($siteSettings['general.support_phone'] ?? ''); ?>" class="gp-topbar-phone">
                        <i class="bi bi-telephone-fill"></i>
                        <?php echo e($siteSettings['general.support_phone'] ?? ''); ?>
        ...
        <nav class="navbar navbar-expand-lg gp-navbar">
            <div class="container">
                ...
                <a class="navbar-brand gp-brand" href="<?php echo e(route('home')); ?>">
                    <img
                        src="<?php echo e(asset('assets/logo.svg')); ?>"
                        alt="GrowPEC Logo"
                ...
                <div class="collapse navbar-collapse" id="navbarContent">
                    ...
                    <div class="gp-header-action">
                        <a href="tel:<?php echo e($siteSettings['general.support_phone'] ?? ''); ?>" class="gp-call-btn">
        ...
        <div class="container">
            ...
            <div class="row gy-5">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="gp-footer-contact">
                        <div>
                            ...
                            <span>
                                <?php echo e($siteSettings['general.office_address'] ?? ''); ?>
                        ...
                        <div>
                            ...
                            <a href="tel:<?php echo e($siteSettings['general.support_phone'] ?? ''); ?>">
                                <?php echo e($siteSettings['general.support_phone'] ?? ''); ?>
                        ...
                        <div>
                            ...
                            <a href="mailto:<?php echo e($siteSettings['general.support_email'] ?? ''); ?>">
                                <?php echo e($siteSettings['general.support_email'] ?? ''); ?>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a href="tel:<?php echo e($siteSettings['general.support_phone'] ?? ''); ?>" class="gp-footer-call">
...
</html><?php /**PATH D:\GrowPec Version Controll\growpec\resources\views/layouts/app.blade.php ENDPATH**/ ?>