<?php $__env->startSection('title', 'Add New College - GrowPec Admin'); ?>
<?php $__env->startSection('header', 'Add New College'); ?>
...
<div class="gc-page">
    ...
    <form action="<?php echo e(route('admin.colleges.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            ...
            <main class="gc-main">
                ...
                <section class="gc-card">
                    ...
                    <div class="gc-card-body">
                        <div class="gc-field">
                            <label class="gc-label">Institution Name <span class="gc-required">*</span></label>
                            <input type="text" name="name" class="gc-control" placeholder="e.g. Amity University / Ganpat University Online" required>
                        </div>

                        <div class="gc-grid-2">
                            <div class="gc-field">
                                <label class="gc-label">Education Mode <span class="gc-required">*</span></label>
                                <select name="college_mode" id="modeSelect" class="gc-control" required>
                                    ...
                                    <option value="both">Regular + Online (creates separate offerings)</option>
                                </select>
                            </div>
                            <div class="gc-field">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="gc-field">
                                            ...
                                            <select name="course_ids[]" class="form-select form-select-sm gc-control course-dropdown" required>
                                                ...
                                                <option value="<?php echo e($c->id); ?>" data-stream-id="<?php echo e($c->stream_id); ?>"><?php echo e($c->name); ?> (<?php echo e($c->level); ?>)</option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="gc-card-body">
                        <div class="gc-field"><label class="gc-label">State <span class="gc-required">*</span></label>
                            <select name="state" id="stateSelect" class="gc-control" required>
                                ...
                                <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($st->name); ?>" data-id="<?php echo e($st->id); ?>"><?php echo e($st->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
...
<script id="streamsJson" type="application/json">
    <?php echo json_encode($streams, 15, 512) ?>
</script>
<script id="coursesJson" type="application/json">
    <?php echo json_encode($courses, 15, 512) ?>
</script>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\GrowPec Version Controll\growpec\resources\views/admin/colleges/create.blade.php ENDPATH**/ ?>