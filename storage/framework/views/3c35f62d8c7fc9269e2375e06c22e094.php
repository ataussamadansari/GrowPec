...
<div class="gp-banner-page">
    ...
    <div class="gp-banner-hero">
        <div class="gp-banner-hero-content">
            ...
            <a href="<?php echo e(route('admin.banners.create')); ?>" class="gp-upload-btn">
    ...
    <div class="gp-banner-card">
        ...
        <div class="gp-banner-toolbar">
            ...
            <span class="gp-banner-count">
                ...
                <?php echo e($banners->total()); ?> <?php echo e($banners->total() == 1 ? 'Banner' : 'Banners'); ?>
                        ...
                        <tr>
                            <td>
                                <div class="gp-banner-preview">
                                    <img
                                        ...
                                        alt="<?php echo e($banner->title ?: 'Hero Banner #' . $banner->id); ?>"
                                        loading="lazy"
                                    >
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="gp-banner-title">
                                    <?php echo e($banner->title ?: 'Hero Banner #' . $banner->id); ?>

                                </div>

                                <span class="gp-banner-date">
                                    <i class="bi bi-calendar3"></i>
                                    <?php echo e($banner->created_at->format('d M Y')); ?>
                            ...
                            <td>
                                <div class="gp-actions">
                                    <a
                                        href="<?php echo e(route('admin.banners.edit', $banner->id)); ?>"
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\GrowPec Version Controll\growpec\resources\views/admin/banners/index.blade.php ENDPATH**/ ?>