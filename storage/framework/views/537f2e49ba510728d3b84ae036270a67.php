<?php $__env->startSection('title', 'Colleges List - GrowPec Admin'); ?>
<?php $__env->startSection('header', 'Manage Colleges'); ?>
...
<div class="college-page">
    ...
    <div class="college-panel">
        ...
        <div class="college-toolbar">
            <form action="<?php echo e(route('admin.colleges.index')); ?>" method="GET">
                ...
                <div class="college-toolbar-form">
                    ...
                    <?php if(request('search')): ?>
                        <a href="<?php echo e(route('admin.colleges.index')); ?>" class="btn college-btn college-clear-btn">
                            <i class="bi bi-x-lg"></i>
                            <span>Clear</span>
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('admin.colleges.create')); ?>" class="btn college-btn college-add-btn">
        ...
        <div class="college-list-head">
            ...
            <span class="college-list-count">
                <?php echo e($colleges->total()); ?> <?php echo e($colleges->total() === 1 ? 'college' : 'colleges'); ?>
        ...
        <div class="college-table-wrap">
            <table class="table college-table align-middle mb-0">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $colleges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                <div class="college-name-cell">
                                    <div class="college-avatar">
                                        <?php if($col->logo): ?>
                                            <img
                                                src="<?php echo e(str_starts_with($col->logo, 'http') ? $col->logo : asset('storage/' . $col->logo)); ?>"
                                    ...
                                    <div>
                                        ...
                                        <?php if($col->university_name): ?>
                                            <div class="college-university" title="<?php echo e($col->university_name); ?>">
                                                <?php echo e($col->university_name); ?>
                            ...
                            <td>
                                <?php if($col->college_mode === 'both'): ?>
                                    <span class="college-badge college-mode-online"><i class="bi bi-layers"></i> Regular + Online</span>
                                <?php elseif($col->college_mode === 'online'): ?>
                                    <span class="college-badge college-mode-online"><i class="bi bi-globe2"></i> Online</span>
                                <?php else: ?>
                                    <span class="college-badge college-mode-regular"><i class="bi bi-building"></i> Regular</span>
                                <?php endif; ?>
                            </td>
                            ...
                            <td>
                                <span class="college-badge college-type">
                                    ...
                                    <?php echo e($col->college_type ?: 'N/A'); ?>
                            ...
                            <td>
                                <div class="college-location">
                                    ...
                                    <span>
                                        <?php echo e($col->city ?: 'N/A'); ?>

                                        <?php if($col->state): ?>
                                            <br><?php echo e($col->state); ?>
                            ...
                            <td>
                                <span class="college-badge college-courses">
                                    ...
                                    <?php echo e($col->courses->count()); ?> Courses
                                </span>
                            </td>
                            ...
                            <td>
                                <span class="college-rating">
                                    ...
                                    <?php echo e($col->rating !== null ? number_format((float) $col->rating, 1) : 'N/A'); ?>
                            ...
                            <td>
                                <div class="college-actions">
                                    ...
                                    <a
                                        href="<?php echo e(route('college.show', $col->slug)); ?>"
                                        target="_blank"
                                        rel="noopener"
                                    ...
                                    <a
                                        href="<?php echo e(route('admin.colleges.edit', $col->id)); ?>"
                                    ...
                                    <form
                                        action="<?php echo e(route('admin.colleges.destroy', $col->id)); ?>"
                                        method="POST"
                                        class="d-inline"
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\GrowPec Version Controll\growpec\resources\views/admin/colleges/index.blade.php ENDPATH**/ ?>