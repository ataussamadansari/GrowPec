<?php $__env->startSection('title', 'Manage Partner Universities - GrowPec Admin'); ?>
<?php $__env->startSection('header', 'Partner Universities Marquee Strip'); ?>
    ...
    <section class="gp-partners-card">
        ...
        <div class="gp-card-head">
            ...
            <span class="gp-card-count">
                <?php echo e($partners->total()); ?> Partners
            </span>
        </div>
        ...
        <div class="gp-card-body">
            ...
            <div class="gp-toolbar">
                ...
                <div class="gp-toolbar-actions">
                    <a href="<?php echo e(route('admin.settings.index')); ?>" class="gp-btn gp-btn-settings">
                        <i class="bi bi-sliders"></i>
                        Section Settings
                    </a>

                    <a href="<?php echo e(route('admin.partners.create')); ?>" class="gp-btn gp-btn-add">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <small class="gp-date">
                                        Added <?php echo e($partner->created_at->format('d M Y')); ?>
            ...
            <?php if($partners->hasPages()): ?>
                <div class="gp-pagination">
                    <?php echo e($partners->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\GrowPec Version Controll\growpec\resources\views/admin/partners/index.blade.php ENDPATH**/ ?>