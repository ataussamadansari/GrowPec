...
<div class="sp-edit-page">
    ...
    <div class="sp-hero">
        <div class="sp-hero-content">
            ...
            <p>
                Update the specialization details, associated course, and visibility
            ...
            <form action="{{ route('admin.specializations.update', $specialization->id) }}" method="POST">
                ...
                <div class="sp-field">
                        ...
                        >
                            ...
                            @foreach($courses as $c)
                                <option
                                    ...
                                    {{ old('course_id', $specialization->course_id) == $c->id ? 'selected' : '' }}
                                >
                    ...
                    <div id="coursePreview" class="sp-course-preview" style="display:none;">
                        ...
                        <div>
                            <div class="sp-preview-label">Selected Course</div>
                            <div id="coursePreviewValue" class="sp-preview-value"></div>
                        </div>
                    </div>
                ...
                <div class="sp-tip">
                    ...
                    <div>
                        <strong>Tip:</strong>
                        Verify the associated course before updating. Changing the course
                        changes where this specialization appears in the academic catalogue.
                    </div>
                </div>

                <div class="sp-actions">
                    <button type="submit" class="btn sp-action-btn sp-update-btn">
