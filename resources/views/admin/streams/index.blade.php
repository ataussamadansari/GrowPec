    ...
    <div class="streams-panel">
        ...
        <div class="streams-toolbar">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <form action="{{ route('admin.streams.index') }}"
                      method="GET"
            ...
            <table class="table table-hover align-middle streams-table">
                ...
                <tbody>
                    @forelse($streams as $st)
                        <tr>
                            <td>
                                <span class="stream-id">#{{ $st->id }}</span>
                            </td>

                            <td>
                                <div class="stream-name-wrap">
                                    <div class="stream-avatar" title="{{ $st->icon ?: 'bi-diagram-3-fill' }}">
                                        <i class="bi {{ $st->icon ?: 'bi-diagram-3-fill' }}"></i>
                                    </div>
                            ...
                            <td>
                                <code class="stream-slug">{{ $st->slug }}</code>
                            </td>

                            <td>
                                <span class="course-count">
                                    <i class="bi bi-book-half"></i>
                                    {{ $st->courses_count }} Courses
                                </span>
                            </td>

                            <td>
                                <div class="action-group">
                                    <a href="{{ route('admin.streams.edit', $st->id) }}"
                                    ...
                                    <form action="{{ route('admin.streams.destroy', $st->id) }}"
                                          method="POST"
                                          class="m-0"
