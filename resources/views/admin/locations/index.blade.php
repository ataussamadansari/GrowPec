...
<style>
    ...
    .gp-locations * { box-sizing:border-box; }
    ...
    .gp-location-hero > * { position:relative; z-index:1; }
    ...
    .gp-filter-btn:hover { background:var(--gp-blue); color:#fff; }
    ...
    .gp-reset-btn:hover { border-color:#C0392B; color:#C0392B; }
    ...
    .gp-table tbody tr { transition:background .16s ease; }
    .gp-table tbody tr:hover { background:#FAFCFF; }
    ...
    .gp-edit { color:var(--gp-blue); }
    .gp-edit:hover { background:#EDF5FE; border-color:#BFD4E9; }

    .gp-delete { color:#C0392B; }
    .gp-delete:hover { background:#FFF5F4; border-color:#E8B8B3; }
    ...
    .gp-pagination nav { margin:0 auto; }
    ...
    .gp-check input { margin:0; accent-color:var(--gp-green); }
    ...
    .gp-modal-save:hover { background:#B78300; color:#fff; }
    ...
    @media (max-width:767.98px) {
        .gp-locations { padding-bottom:18px; }
        ...
        .gp-location-hero h2 { font-size:1.12rem; }
        .gp-location-hero p { font-size:.67rem; }
        ...
        .gp-panel { border-radius:13px; }

        .gp-panel-head {
            padding:11px 12px;
        }

        .gp-panel-body { padding:10px; }
        ...
        .gp-heading h3 { font-size:.77rem; }
        .gp-heading small { font-size:.55rem; }
        ...
        .gp-modal-footer { padding:10px 14px; }
    }
                        ...
                        <tbody>
                            @forelse($cities as $ct)
                                <tr>
                                    <td>
                                        <div class="gp-name">
                                            <span class="gp-row-icon"><i class="bi bi-buildings"></i></span>
