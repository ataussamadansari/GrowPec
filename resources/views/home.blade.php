        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <p class="lead mb-4 text-white-50 max-w-xl mx-auto">
                    Compare verified fees, check NAAC & UGC approvals, get scholarship assistance, and connect with top counselors.
                </p>
                ...
                <div class="hero-search-box">
                    <form action="{{ route('colleges.regular') }}" method="GET" class="d-flex flex-column flex-md-row gap-2">
                        <div class="d-flex align-items-center flex-grow-1 px-2">
                            ...
                            <input type="text" name="search" class="hero-search-input" placeholder="Search college name, course (e.g. BCA, MBA, B.Tech), or city...">
                        </div>
                ...
                <div class="d-flex flex-wrap gap-4 justify-content-center text-white mt-2">
                    <div>
                        ...
                        <small class="text-white-50">Verified Colleges</small>
                    </div>
                    <div class="vr bg-secondary"></div>
                    <div>
                        <h4 class="fw-bold mb-0 text-warning">15,000+</h4>
                        <small class="text-white-50">Students Guided</small>
                    </div>
                    <div class="vr bg-secondary"></div>
                    <div>
                        <h4 class="fw-bold mb-0 text-warning">100%</h4>
                        <small class="text-white-50">Verified Details</small>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="college-card">
                    <div class="position-relative">
                        <img src="{{ $college->banner_url }}" class="college-card-img" alt="{{ $college->name }}">
                    ...
                    <div class="p-4 d-flex flex-column flex-grow-1">
                        ...
                        <div class="mt-auto pt-3 border-top d-flex gap-2">
                            ...
                            <button class="btn btn-gold btn-sm fw-bold px-3" onclick="openEnquiryModal('{{ $college->city }}')">
                                Apply Now
                            </button>
                        </div>
                    </div>
...
<section class="py-5 bg-white">
    <div class="container">
        <div class="text-center max-w-xl mx-auto mb-5">
            <h2 class="fw-bold" style="color: var(--primary-purple);">Why Choose GrowPec?</h2>
